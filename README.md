...
<h3 align="center">Soy un apasionado del desarrollo de aplicaciones móviles nativas, y mi objetivo es crear experiencias fluidas y de alta calidad para los usuarios con arquitecturas escalables y altamente productivas como son movile (mvvm,mvc,mvp),backend (n-capas,hexagonal).bajo un esquema de trabajo regido por scrum y con principios de metodologia agil
